...
export default class TicketPoster extends Component {
	...
	render() {
		//Pull out the values from the ticket prop and assign to consts aswell as the onOpen function
		...
		return (
			<TouchableOpacity style={styles.container} onPress={() => onOpen(ticket)}>
				<View style={styles.imageContainer}>
					{/*Set the image background to the ticket with the correct color */}
					<ImageBackground
