...
export default class ForgotPassword extends React.Component {
	...
	//Resets the password using the method provided by firebase
	...
	render() {
		return (
			<LinearGradient style={{
				...
				<Text style={Styles.travelText} titleStyle={{fontWeight: 'bold', letterSpacing: 50,}}>Forgot your
					password? </Text>
				<Input
					leftIcon={
						<Icon
				...
				/>
				<View>
					<Button title={'Send Password'} buttonStyle={Styles.buttonStyleForgot}
