    ...
    return (
      <TouchableOpacity style={styles.container} onPress={() => onOpen(bar)}>
        <View style={styles.imageContainer}>
          <Image source={{uri: image ? image : 'https://ichef.bbci.co.uk/news/660/cpsprodpb/16620/production/_91408619_55df76d5-2245-41c1-8031-07a4da3f313f.jpg'}} style={styles.image}/>
        </View>
